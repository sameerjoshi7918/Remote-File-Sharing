...
def only_me_chat_open():#2
    ...
    try:
        ...
        try:
            a=pg.locateOnScreen(r'images\Search_or_what.png')
        except:
            only_me_chat_open()
...
def check():#3
    ...
    if os.path.exists('images\online_access.png'):
        ...
        im = pg.screenshot('images\online_access.png',region=(1307,838,516,65))#1107,838,516,65
    try:
        print('try strarted')
        print(pytesseract.image_to_string(Image.open(r'images\online_access.png')))##ERROR HERE
        query1=pytesseract.image_to_string(Image.open(r'images\online_access.png'))
        print('###################')
        ...
        if 'Python' in first_input:
            ...
            if first_input[num+1]=='start':
                ...
                def gogototo():
                    print('in goto')
                    try:
                        loc=pg.locateOnScreen(r'images\type_a_message.png')#error here
                    except:
                        gogototo()
                    print('after goto')
                    if loc=='None':
                ...
                def fetch_it():
                    ...
                    time.sleep(1)
                    im = pg.screenshot('images\online_access.png',region=(1307,838,516,65))
                    query1=pytesseract.image_to_string(Image.open(r'images\online_access.png'))#string
                    user=query1.split()
                    print(user)
                    if 'end' in user:
                ...
                def drive_function(user_ans):
                    ...
                    def file_extraction():
                        ...
                        if '.' in folder_explore[-1]:
                            ...
                            print("directory check : ", directory)
                            #kd.wait(hotkey='enter')
                        else:
                            cur_di=folder+'/'
